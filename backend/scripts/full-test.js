...
async function runFullTest() {
  ...
  await prisma.business.update({
    ...
    data: {
      welcomeMessage:
        "¡Hola {{clientName}}! Hemos confirmado tu cita para el {{appointmentDate}} a las {{appointmentTime}} en {{businessName}}.",
      reminderMessage:
        "Hola {{clientName}}, recordatorio de tu cita mañana en {{businessName}} a las {{appointmentTime}}.",
    },
  });
