...
// PUT update business
router.put('/:id', authenticate, validateId('id'), validateBody(updateBusinessSchema), asyncHandler(businessController.updateBusiness));

// GET business hours
router.get('/:id/hours', authenticate, validateId('id'), asyncHandler(businessController.getHours));

// PUT update business hours
router.put('/:id/hours', authenticate, validateId('id'), validateBody(updateHoursSchema), asyncHandler(businessController.updateHours));
