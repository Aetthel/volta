...
export const createUserSchema = z.object({
  ...
  role: z.enum(["ADMIN", "JEFE", "EMPLEADO"], { message: "Rol no válido" }),
...
export type UpdateHolidaysInput = z.infer<typeof updateHolidaysSchema>;
...
export type BookingIdentityStartInput = z.infer<typeof bookingIdentityStartSchema>;

export const bookingIdentityVerifySchema = z.object({
  phone: phoneField,
  code: z.string().regex(/^\d{6}$/, "El código debe tener 6 dígitos"),
});
export type BookingIdentityVerifyInput = z.infer<typeof bookingIdentityVerifySchema>;
