...
- **Specialty Components:**
  - _Booking Calendar:_ Use soft, rounded blocks for appointments.
  - _Status Indicators:_ Use muted, earthy versions of green/red/yellow to stay within the organic palette.
