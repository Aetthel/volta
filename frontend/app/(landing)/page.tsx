          ...
          <div className="max-w-container-max mx-auto px-6 md:px-16 lg:px-24 xl:px-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-start text-left z-10">
              ...
              <h1 className="font-display text-display-lg md:text-[52px] lg:text-[56px] text-on-surface leading-tight font-bold mb-6">
                ...
                <span className="text-primary italic font-medium">precisión profesional</span>
              </h1>
              <p className="text-body-lg text-on-surface-variant max-w-lg mb-8 leading-relaxed">
                La plataforma todo en uno para peluquerías, clínicas, centros de estética,
                gimnasios, consultorías y cualquier negocio de servicios que busca profesionalidad,
                eficiencia y una experiencia de cliente superior.
              </p>
            ...
            <div className="relative w-full aspect-[4/3] max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="w-full h-full bg-white rounded-2xl border border-outline-variant p-4 shadow-xl transition-all duration-350 relative z-10 flex flex-col gap-3.5 text-left overflow-hidden">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-16 h-8 rounded-lg bg-surface-container border border-outline-variant/30 flex items-center justify-center text-label-xs text-on-surface-variant">
                    Filtrar
                  </div>
                </div>
                ...
                <div className="flex-grow flex flex-col gap-2.5 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container/30 border border-outline-variant/20 hover:bg-surface-container/50 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-primary/10 text-primary font-bold flex items-center justify-center text-title-xs shrink-0">
                        AG
                      </div>
                      <div>
                        <div className="text-title-xs font-semibold text-on-surface">
                          Ana García
                        </div>
                        <div className="text-[10px] text-on-surface-variant leading-none mt-0.5">
                          +34 611 234 567
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container/30 border border-outline-variant/20 hover:bg-surface-container/50 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-secondary/10 text-secondary font-bold flex items-center justify-center text-title-xs shrink-0">
                        MP
                      </div>
                      <div>
                        <div className="text-title-xs font-semibold text-on-surface">
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container/30 border border-outline-variant/20 hover:bg-surface-container/50 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="w-7 h-7 rounded-full bg-amber-500/10 text-amber-600 font-bold flex items-center justify-center text-title-xs shrink-0">
                        SM
                      </div>
                      <div>
                        <div className="text-title-xs font-semibold text-on-surface">
          ...
          <div className="max-w-container-max mx-auto px-6 md:px-16 lg:px-24 xl:px-32 relative z-10 flex flex-col gap-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-outline-variant min-h-[300px] flex flex-col p-5 relative group overflow-hidden text-left justify-between">
                  ...
                  <div className="flex-grow flex flex-col justify-between">
                    ...
                    <div className="h-14 flex gap-3 items-start relative pt-1">
                      <span className="text-[10px] font-medium text-on-surface-variant/60 w-8 select-none">
                        09:00
                      </span>
                      ...
                      <div className="absolute left-11 right-4 top-1 bottom-1 bg-primary/10 border-l-4 border-primary rounded-r p-2 flex flex-col justify-center">
                        ...
                        <div className="text-[9px] text-primary/80 mt-0.5">
                          Consulta inicial • 09:00 - 09:45
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="h-16 flex gap-3 items-start relative pt-1">
                      ...
                      <div className="absolute left-11 right-4 top-1 bottom-1 bg-secondary-container/20 border-l-4 border-secondary rounded-r p-2 flex flex-col justify-center z-10 shadow-sm">
                        <div className="text-[11px] font-bold text-secondary leading-tight">
                          Ana García
                        </div>
                        <div className="text-[9px] text-secondary/80 mt-0.5">
                          Sesión completa • 10:00 - 11:30
                        </div>
                      </div>
                    </div>
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-body-lg text-on-surface-variant mb-8 leading-relaxed">
                  Optimiza cada minuto de tu jornada. Nuestro motor de reservas inteligente previene
                  solapamientos, gestiona tiempos entre citas y envía recordatorios automáticos por
                  WhatsApp con confirmación bidireccional.
                </p>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-body-md text-on-surface-variant">
                        Bloqueo automático de tiempos de desarrollo técnicos.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-body-md text-on-surface-variant">
                        SMS, Email y WhatsApp integrados nativamente.
                      </p>
                    </div>
                  </li>
                </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-body-lg text-on-surface-variant mb-8 leading-relaxed">
                  Deja de adivinar. Obtén visibilidad total sobre la salud financiera de tu negocio,
                  retención de clientes, rendimiento del equipo y rentabilidad en tiempo real con
                  paneles de control precisos.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center mt-1 shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-body-md text-on-surface-variant">
                        Identifica patrones de clientes en riesgo de abandono.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-body-md text-on-surface-variant">
                        Alertas de bajo stock y cálculo de coste por servicio.
                      </p>
                    </div>
                  </li>
                </ul>
                  ...
                  <div className="flex-grow flex flex-col gap-2 overflow-hidden">
                    ...
                    <div className="h-24 flex items-end justify-between px-2 pt-2 gap-4">
                      ...
                      <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                        <div
                          className="w-full bg-primary/20 hover:bg-primary/30 transition-colors rounded-t-md"
                          style={{ height: "45%" }}
                        ></div>
                        <span className="text-[8px] font-medium text-on-surface-variant/60 select-none">
                          Sem 1
                        </span>
                      </div>
                      {/* Bar 2 */}
                      ...
                      <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                        <div
                          className="w-full bg-primary/60 hover:bg-primary/70 transition-colors rounded-t-md"
                          style={{ height: "85%" }}
                        ></div>
                        <span className="text-[8px] font-medium text-on-surface-variant/60 select-none">
                          Sem 3
                      ...
                      <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                        <div
                          className="w-full bg-primary/30 hover:bg-primary/40 transition-colors rounded-t-md"
                          style={{ height: "50%" }}
                        ></div>
                        <span className="text-[8px] font-medium text-on-surface-variant/60 select-none">
                          Sem 4
          ...
          <div className="max-w-container-max mx-auto px-6 md:px-16 lg:px-24 xl:px-32">
            <div className="text-center mb-16">
              ...
              <p className="text-body-lg text-on-surface-variant max-w-2xl mx-auto">
                Escala tu negocio con la transparencia de Volta. Precios claros, sin sorpresas
                ocultas.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch">
              ...
              <Card className="p-8 flex flex-col hover:shadow-md transition-shadow">
                <div className="mb-8">
                  ...
                  <h4 className="text-display font-bold text-on-surface mb-2">A medida</h4>
                  <p className="text-body-md text-on-surface-variant italic">
                ...
                <div className="mt-8 space-y-3">
                  <Link href="/login">
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full bg-surface-container border-outline-variant text-on-surface hover:bg-surface-container-high"
                    >
                      Contactar Ventas
                    </Button>
                  </Link>
              ...
              <div className="flex flex-col gap-8">
                ...
                <Card className="bg-white p-6 flex flex-col gap-6 border-outline-variant/30">
                  <p className="text-body-lg text-on-surface-variant italic leading-relaxed">
                    "Volta ha transformado la forma en que gestiono mi negocio. La interfaz proyecta
                    la profesionalidad que mis clientes esperan y me ahorra horas cada semana."
                  </p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-label-md text-primary font-semibold">
                        Directora de Centro de Fisioterapia
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="bg-white p-6 flex flex-col gap-6 border-outline-variant/30 lg:ml-8">
                  <p className="text-body-lg text-on-surface-variant italic leading-relaxed">
                    "La analítica avanzada me permitió optimizar mis recursos un 20% en solo tres
                    meses. Es la herramienta definitiva para cualquier negocio de servicios."
                  </p>
                  <div className="flex items-center gap-4">
                    {/* Minimalist White Profile Placeholder */}
                    <div className="w-12 h-12 rounded-full border border-outline-variant bg-surface-container-lowest flex items-center justify-center text-on-surface-variant">
              ...
              <div className="hidden lg:block">
                <div className="relative h-[360px] w-full rounded-2xl overflow-hidden shadow-lg border border-white bg-white flex flex-col items-center justify-center p-8 group">
                  ...
                  <p className="text-body-md text-on-surface-variant text-center max-w-sm">
                    Reconocido como el software de gestión de citas y negocios con mejor
                    satisfacción de usuario de este año.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="border border-outline-variant rounded-2xl overflow-hidden transition-all bg-surface"
                  >
                    <button
                    ...
                    >
                      <span className="text-title-md font-bold text-on-surface">{item.q}</span>
                      {isOpen ? (
                    ...
                    <div
                      className={`transition-all duration-300 ease-in-out ${
                        isOpen
                          ? "max-h-[200px] border-t border-outline-variant/30 opacity-100 p-6 bg-white"
        ...
        <section className="py-24 text-center px-6 md:px-16 lg:px-24 xl:px-32 bg-surface">
          <div className="max-w-4xl mx-auto bg-primary rounded-[32px] p-12 md:p-20 shadow-xl relative overflow-hidden border-4 border-primary/20 text-on-primary">
            ...
            <p className="text-body-lg text-white/90 mb-12 relative z-10 max-w-2xl mx-auto">
              Únete a los más de 1.500 negocios que ya han profesionalizado su gestión con Volta.
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
              <Link href="/register">
                <Button
                  variant="secondary"
                  size="lg"
                  className="w-full sm:w-auto bg-white text-primary hover:bg-surface-container-lowest"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-2 flex flex-col items-start">
              ...
              <p className="text-body-md text-on-surface-variant mb-6 max-w-sm leading-relaxed">
                La plataforma profesional para la gestión integral de negocios de servicios:
                peluquerías, clínicas, gimnasios, consultorías y más.
              </p>
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 rounded-full bg-surface-container-high flex items-center justify-center text-on-surface-variant hover:bg-primary hover:text-white transition-colors"
