        ...
        <main className="p-gutter max-w-container-max w-full mx-auto flex-1">
          ...
          <section className="flex flex-col md:flex-row md:items-end justify-between gap-lg mb-xl">
            ...
            <div className="flex items-center gap-sm">
              <button className="flex items-center gap-xs px-lg py-sm rounded-lg border border-outline text-primary font-label-lg text-label-lg hover:bg-secondary-container/30 transition-all cursor-pointer">
                <Download className="w-4 h-4" />
                <span>Exportar</span>
              </button>
              <button 
                onClick={() => setIsClientModalOpen(true)}
                className="flex items-center gap-xs px-lg py-sm rounded-lg bg-primary text-on-primary font-label-lg text-label-lg shadow-sm hover:bg-primary-container hover:text-on-primary-container active:scale-[0.98] transition-all cursor-pointer"
              >
          ...
          <section className="grid grid-cols-1 md:grid-cols-4 gap-gutter mb-xl">
            ...
            <div className="md:col-span-2 bg-primary-container text-on-primary-container p-lg rounded-xl shadow-sm relative overflow-hidden group flex flex-col justify-between">
              <div className="relative z-10">
                <h4 className="font-title-md text-title-md mb-xs font-semibold">
                  Programa de Fidelización
                </h4>
                <p className="font-body-md text-body-md opacity-90 mb-md max-w-[280px] leading-relaxed">
                  24 clientes están cerca de su próximo servicio gratuito.
                </p>
              </div>
              <button className="bg-on-primary-container text-primary hover:bg-primary-fixed hover:text-on-primary-fixed px-lg py-xs rounded-full font-label-md text-label-md self-start transition-all cursor-pointer font-semibold shadow-sm">
                Ver detalles
              </button>
            ...
            <div className="p-lg border-b border-outline-variant flex flex-col md:flex-row md:items-center justify-between gap-md">
              ...
              <div className="flex items-center gap-sm">
                <select 
                  ...
                  className="bg-surface-container border-none rounded-lg text-label-md font-label-md font-semibold focus:ring-2 focus:ring-primary text-on-surface-variant px-md py-sm focus:outline-none cursor-pointer"
                >
                ...
                <button className="p-sm hover:bg-surface-variant rounded-full text-on-surface-variant transition-colors cursor-pointer bg-surface-container">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-surface-container-low select-none">
                    <th className="px-lg py-md font-label-md text-label-md text-on-surface-variant uppercase tracking-wider font-semibold border-b border-outline-variant">
                      Cliente
                    </th>
                    <th className="px-lg py-md font-label-md text-label-md text-on-surface-variant uppercase tracking-wider font-semibold border-b border-outline-variant">
                      Teléfono
                  ...
                  {filteredClients.length > 0 ? (
                    filteredClients.map((client) => (
                      ...
                      >
                        ...
                        {/* Phone */}
                        <td className="px-lg py-md text-body-lg text-on-surface font-medium">
                          {client.phone}
                        </td>
                        {/* Last Visit */}
                        <td className="px-lg py-md text-body-lg text-on-surface font-medium">
                        ...
                        <td className="px-lg py-md">
                          <span className="inline-block px-sm py-[2px] rounded-full text-label-md font-semibold bg-surface-container text-primary">
                        ...
                        <td className="px-lg py-md">
                          <div className="flex items-center gap-sm">
                            <button className="p-sm rounded-full text-outline hover:text-primary hover:bg-surface-container transition-colors cursor-pointer">
                            ...
                            <button 
                              ...
                              className="p-sm rounded-full text-outline hover:text-error hover:bg-error-container/20 transition-colors cursor-pointer"
                            >
                    ...
                    <tr>
                      <td colSpan={5} className="px-lg py-xl text-center text-on-surface-variant text-body-lg">
