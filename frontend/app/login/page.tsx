...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const callbackUrl = email === "admin@glowstudio.com" ? "/admin" : "/dashboard";
      ...
      if (result?.error) {
        setError("Credenciales incorrectas. Usa contacto@glowstudio.com / 123456");
        setIsLoading(false);
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center p-margin-mobile md:p-gutter bg-surface">
      ...
      <div className="w-full max-w-6xl h-[920px] md:h-[820px] min-h-[600px] flex rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-surface-container-lowest border border-outline-variant">
        ...
        <div className="hidden md:flex flex-col justify-between w-1/2 relative bg-surface-container-low overflow-hidden">
          ...
          {/* Content overlay */}
          <div className="relative z-10 p-xl flex flex-col h-full justify-between text-surface-container-lowest">
            <div>
              <h1 className="font-display text-display-lg font-bold mb-xs drop-shadow-md">
                Glow Studio
              </h1>
            ...
            <div className="bg-white/85 backdrop-blur-md border border-white/30 p-md rounded-xl max-w-sm text-on-surface">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center p-xl md:p-[64px] bg-surface-container-lowest relative z-20">
          <div className="max-w-md w-full mx-auto">
            {/* Mobile Header (Visible only on small screens) */}
            <div className="md:hidden text-center mb-xl">
              <h1 className="font-display text-headline-lg-mobile text-primary font-semibold mb-xs">
                Glow Studio
              </h1>
            ...
            {/* Form Header */}
            <div className="mb-lg">
              <h2 className="font-display text-headline-lg text-on-surface font-semibold mb-xs">
                Iniciar Sesión
              </h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-lg">
              {error && (
                <div className="bg-error-container text-on-error-container border border-error-container/60 p-sm rounded-lg text-center text-body-md font-semibold select-none">
                  {error}
                </div>
              )}
              {/* Email Input */}
              <div className="flex flex-col gap-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-[40px] pr-sm py-[12px] bg-surface text-body-lg text-on-surface border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none transition-all placeholder-outline-variant shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-xs">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-sm flex items-center text-outline hover:text-on-surface focus:outline-none cursor-pointer"
                  >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-[12px] px-md border border-transparent rounded-lg shadow-[0_4px_14px_0_rgba(0,128,128,0.15)] text-on-primary bg-primary hover:bg-primary-container disabled:opacity-50 focus:outline-none transition-all active:scale-[0.98] font-label-lg text-label-lg cursor-pointer"
              >
            ...
            <div className="my-lg">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-sm bg-surface-container-lowest font-label-md text-label-md text-outline">
                    O continuar con
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-md">
              <button
                type="button"
                className="flex justify-center items-center py-sm px-md border border-outline-variant rounded-lg shadow-sm bg-surface hover:bg-surface-variant font-label-md text-label-md text-on-surface transition-colors cursor-pointer gap-sm"
              >
