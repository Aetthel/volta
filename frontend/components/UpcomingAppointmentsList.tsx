  ...
  return (
    <>
      {appointments.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center p-8 bg-white border border-outline-variant/60 rounded-2xl text-center shadow-[0_1px_3px_rgba(0,0,0,0.02)] select-none">
          <CalendarIcon className="w-8 h-8 text-slate-300 mb-2" />
          <p className="font-semibold text-slate-600 text-body-md">No hay próximas citas programadas</p>
          <p className="text-slate-400 text-body-sm mt-0.5 font-medium">Tus citas programadas para los próximos días aparecerán aquí.</p>
        </div>
      )}
    </>
  );
