...
import { Calendar, Smartphone, Settings, LogOut } from "lucide-react";
...
export default function BusinessSidebar() {
  ...
  return (
    <div className="flex flex-col h-full w-64 bg-white dark:bg-[#0A0A0A] border-r border-neutral-100 dark:border-neutral-900">
      <div className="p-8">
        <h1 className="text-3xl font-display font-bold tracking-tight text-solar">Volta</h1>
        <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 mt-1">Business Panel</p>
      </div>
