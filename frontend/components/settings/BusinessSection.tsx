...
import {
  ...
  Users, UserPlus, Edit2, Trash2, User, Globe, CreditCard, Sparkles, Copy, Check, ExternalLink
} from "lucide-react";
        ...
        {!isEditingHours && !loadingHours && (
          <CardFooter className="pt-4 border-t border-outline-variant/35">
            <Button variant="outline" size="sm" onClick={() => setIsEditingHours(true)}
              className="w-full py-2 text-xs font-semibold">Modificar Horarios</Button>
          </CardFooter>
        )}
      </Card>
