...
export default function BusinessSection({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-gutter animate-in fade-in duration-200">
      ...
      {/* Operating Hours Card - Placed next to Business Info in Row 1 */}
      <Card className="col-span-1 sm:col-span-2 lg:col-span-4 flex flex-col justify-between">
        <div>
            ...
            {loadingHours ? (
              <div className="flex flex-col gap-4 py-2">
                {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between py-1 border-b border-outline-variant/30"
                  >
              ...
              <div className="flex flex-col gap-2.5 sm:gap-3.5 font-medium text-body-md text-on-surface-variant">
                {hours.map((h) => (
                  <div
                    key={h.dayOfWeek}
              ...
              <form onSubmit={handleSaveHours} className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer text-xs text-on-surface-variant select-none">
                        <input
                          ...
                          onChange={(e) => {
                            const u = [...hours];
                            u[idx] = { ...u[idx], isClosed: e.target.checked };
                            setHours(u);
                          }}
                      ...
                      <div className="flex items-center gap-2 w-full mt-2">
                        <div className="flex-1 min-w-0">
                          <FloatingInput
                            ...
                            onChange={(e) => {
                              const u = [...hours];
                              u[idx] = { ...u[idx], openTime: e.target.value };
                              setHours(u);
                            }}
                          />
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <FloatingInput
                            ...
                            onChange={(e) => {
                              const u = [...hours];
                              u[idx] = { ...u[idx], closeTime: e.target.value };
                              setHours(u);
                            }}
                          />
                        </div>
                ...
                <div className="flex justify-end gap-2 mt-4 pt-2 border-t border-outline-variant/35">
                  ...
                  >
                    {savingHours && <Loader2 className="animate-spin" />}
                    <span>Guardar</span>
                  </Button>
                </div>
              </form>
        ...
        {!isEditingHours && !loadingHours && (
          <CardFooter className="pt-4 border-t border-outline-variant/35">
            <Button
              variant="outline"
              size="sm"
      ...
      {/* Row 2: Public Online Booking Dedicated Card Container */}
        ...
        <div>
          <CardHeader className="flex flex-row items-center justify-between pb-4">
            ...
            <Button
              ...
              onClick={() => {
                ...
                setToast({
                  show: true,
                  text: newValue ? "Reservas públicas activadas" : "Reservas públicas desactivadas",
                });
                setTimeout(() => setToast({ show: false, text: "" }), 3000);
              }}
          ...
          <CardContent className="flex flex-col gap-4">
            <p className="text-body-sm text-on-surface-variant leading-relaxed">
              Permite a tus clientes agendar sus citas de forma autónoma desde un enlace web público
              personalizado, sin necesidad de crear cuenta o introducir contraseña.
            </p>
            {profile.enablePublicBooking !== false ? (
              ...
              <div className="p-3.5 bg-surface-container-low border border-outline-variant/40 rounded-xl text-body-xs text-on-surface-variant">
                Las reservas públicas están desactivadas. Los clientes no podrán acceder a tu portal
                web hasta que lo reactives.
              </div>
            )}
          </CardContent>
        </div>

        <CardFooter className="pt-4 border-t border-outline-variant/35 flex justify-end">
          <Button
            variant="outline"
            size="sm"
            disabled={profile.enablePublicBooking === false}
            onClick={() => {
              const url = `${window.location.origin}/booking/${businessId}`;
