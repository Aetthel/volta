...
export const Field = React.forwardRef<HTMLDivElement, FieldProps>(
  (
    { className, orientation = "vertical", "data-invalid": invalid, "data-disabled": disabled, ...props },
    ref
  ) => {
    return (
      <div
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("font-title-lg text-title-lg text-on-surface font-semibold", className)} {...props} />
  )
);
...
export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("font-body-md text-body-md text-on-surface-variant", className)} {...props} />
  )
);
    ...
    return (
      <div className="relative w-full group/input">
        ...
        <input
          ...
          placeholder=" "
          className={cn(
            "peer block w-full bg-transparent text-body-lg text-on-surface border border-outline rounded-xl focus:border-primary focus:border-2 focus:outline-none transition-all py-3.5 pr-4",
            Icon ? "pl-12" : "pl-4",
        ...
        <label
          ...
          className={cn(
            ...
            Icon ? "left-12 peer-focus:left-3 peer-[:not(:placeholder-shown)]:left-3" : "left-4"
          )}
        >
          {label}
        </label>
