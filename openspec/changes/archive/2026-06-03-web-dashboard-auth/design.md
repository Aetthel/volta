...
- **Typography**: Pair a high-contrast Display Serif (e.g., *Cormorant Garamond* style) for headings with a characterful Geometric Sans (e.g., *Syne* or *Space Grotesk*) for functional data. Avoid generic fonts like Inter.
