...
- **[Riesgo] Bloqueo de cuentas por spam de WhatsApp**
  - *Mitigación*: Se implementa un retardo aleatorio de 2-5 segundos entre envíos en el Sentinel (`runSentinel`) para emular el comportamiento humano.
- **[Riesgo] Consumo excesivo de memoria por Puppeteer**
  - *Mitigación*: Destruir por completo la instancia de `Client` al recibir desconexión o error de autenticación, liberando los procesos de Chromium asociados.
