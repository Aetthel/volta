...
- **[Riesgo]** Las acciones en móvil podrían ocupar demasiado espacio si hay muchos botones.
  - *Mitigación:* Limitar los botones en cabecera a máximo 2. Si se colapsa en móvil, se apilarán debajo del título gracias a `flex-col md:flex-row`.
- **[Riesgo]** Rediseño en agenda.
  - *Mitigación:* Se validó que `/agenda` ya no tiene cabecera antes del Card, por lo que no realizaremos ningún cambio en esa página.
