...
- **[Riesgo]** Complejidad de Jest con ES Modules nativos.
  - _Mitigación:_ Se configurará Jest usando variables de entorno de Node.js (`NODE_OPTIONS=--experimental-vm-modules`) para dar soporte nativo a ES Modules sin necesidad de compiladores externos como Babel.
