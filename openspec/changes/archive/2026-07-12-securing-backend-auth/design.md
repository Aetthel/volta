...
- **[Riesgo]** Clave secreta no configurada en producción.
  - *Mitigación:* Si la variable de entorno `BACKEND_JWT_SECRET` no está establecida en el backend, el servidor Express lanzará un error fatal en el arranque para evitar que funcione sin firma criptográfica.
