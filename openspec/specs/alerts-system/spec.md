# Capability: Alerts System

## Purpose

Provides the ability for the platform and administrators to manage user notifications, critical warnings, and popup onboarding carousels.
